...
export class NgxFixedColumnTableComponent implements OnInit, AfterViewInit {
  ...
  public fitSizeFixedHeader() {
    ...
    fixedHeaderWrapper.style.setProperty('left', tableRect.left + 'px');
    ...
    columnElements.forEach((columnElement: HTMLElement, index: number) => {
      ...
      fixedHeaderColumn.style.setProperty('width', width - padding - 4 + 'px');
      fixedHeaderColumn.style.setProperty('height', height - padding + 'px');
